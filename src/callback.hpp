...
public:
	CBFunctionTranslator0wRet(Func f):CBFunctor0wRet<RT>(thunk,0,(CBFunctorBase::PFunc)f,0,0){}
	static RT thunk(const CBFunctorBase &ftor)
		{
...
public:
	CBFunctionTranslator1(Func f):CBFunctor1<P1>(thunk,0,(CBFunctorBase::PFunc)f,0,0){}
	static void thunk(const CBFunctorBase &ftor,P1 p1)
		{
...
public:
	CBFunctionTranslator2(Func f):CBFunctor2<P1,P2>(thunk,0,(CBFunctorBase::PFunc)f,0,0){}
	static void thunk(const CBFunctorBase &ftor,P1 p1,P2 p2)
		{
...
public:
	CBFunctionTranslator3(Func f):CBFunctor3<P1,P2,P3>(thunk,0,(CBFunctorBase::PFunc)f,0,0){}
	static void thunk(const CBFunctorBase &ftor,P1 p1,P2 p2,P3 p3)
		{
